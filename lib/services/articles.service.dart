...
class ArticlesService {
  ...
  static favorite(String slug) async => await http.post('/articles/$slug/favorite');
  ...
  static unfavorite(String slug) async => await http.delete('/articles/$slug/favorite');

  static update(String slug, Map<String, dynamic> data) async => await http.put('/articles/$slug', data: data);

  static create(Map<String, dynamic> data) async => await http.post('/articles', data: data);
